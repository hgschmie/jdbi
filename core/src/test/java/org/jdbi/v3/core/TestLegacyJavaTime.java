...
public class TestLegacyJavaTime extends AbstractJavaTimeTests {
    ...
    /**
     * Legacy LocalTime mapper only supports second granularity. Set nanos to zero.
     */
    @Override
    ...
    /**
     * Result maps to the default zone. Test is a bit convoluted because the result only contains an offset because Offset may map to multiple zones.
     */
    @Override
